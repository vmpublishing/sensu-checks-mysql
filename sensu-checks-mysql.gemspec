...
if RUBY_VERSION < '2.0.0'
  require 'sensu-checks-mysql'
else
  require_relative 'lib/sensu-checks-mysql'
end
...
Gem::Specification.new do |s|
  ...
  s.email                  = 'dev@vmpublishing.com'
  s.executables            = Dir.glob('bin/**/*.rb').map { |file| File.basename(file) }
  s.files                  = Dir.glob('{bin,lib}/**/*') + %w(LICENSE README.md CHANGELOG.md)
  s.homepage               = 'https://github.com/sensu-plugins/sensu-checks-mysql'
  s.license                = 'MIT'
  s.metadata               = {
                               'maintainer'         => 'dev@vmpublishing.com',
                               'development_status' => 'active',
                               'production_status'  => 'stable',
                             }
  s.name                   = 'sensu-checks-mysql'
